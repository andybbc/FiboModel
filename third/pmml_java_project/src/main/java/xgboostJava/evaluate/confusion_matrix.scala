...
//        val predictFilePath: String = args(1)
        ...
        val originFilePath = "E:\\gitdir\\projects\\untitled\\src\\main\\resources2\\predict_real.txt"
        val predictFilePath = "E:\\gitdir\\projects\\untitled\\src\\main\\resources2\\predict_res.txt"
