...
public class PMMLPredictionOne {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pathxml = "E:\\gitdir\\learn_projects\\python_projects\\algorithm2\\third\\pmml_java_project\\src\\main\\resources\\xgb_model.pkl_3_pipeline";
        beforeDo(pathxml);
