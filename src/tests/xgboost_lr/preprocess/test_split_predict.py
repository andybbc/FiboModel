...
def process_demo():
    dic_config = {
        "logger": 1,
        "origin_path": "../../../../data/xgboost_lr/etl/criteo_sampled_data_no_header_need_predict.csv",
        "split_cols_file_path": "../../../../data/xgboost_lr/preprocess/criteo_sampled_data_no_header_need_predict_select_col.csv",
        "encode_file_path": "../../../../data/xgboost_lr/feature/criteo_sampled_data_no_header_need_predict_encode.csv",
