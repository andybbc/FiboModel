...
def init():
    ...
    dic_config[
        "predict_input_file_path"] = '../../../../data/xgboost/feature/criteo_sampled_data_no_header_need_predict_encode.csv'  # 需要被预估的原始文件的路径,列只包括click往后的字段
    dic_config[
        'predict_output_file_path'] = '../../../../data/xgboost/predict/criteo_sampled_data_no_header_need_predict_res.csv'

    dic_config["file_separator"] = "#"  # 每一行文件分隔符
    dic_config["xgb_model_path"] = "../../../../data/xgboost/train/xgb_model.pkl"
    dic_config['need_label_encode_cols_num'] = 20
