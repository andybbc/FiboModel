...
def init():
    ...
    dic_config["predict_input_file_path"] = '../../../../data/xgboost_lr_product/feature/need_predict.csv'
    dic_config['predict_output_file_path'] = '../../../../data/xgboost_lr_product/predict/need_predict.res'

    dic_config["file_separator"] = "#"  # 每一行文件分隔符
    dic_config["xgb_model_path"] = "../../../../data/xgboost_lr_product/train/xgb_model.pkl"
...
def predict():
    ...
    logger.info("""
            ##########################################
            ##### xgboost_lr_product Predict_Batch START #####
            ##########################################
            """)
