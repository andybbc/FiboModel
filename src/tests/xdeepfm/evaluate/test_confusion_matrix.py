...
def process_demo():
    in_predict_real_file_path = "../../../../data/xdeepfm/etl/criteo_sampled_data_no_header_need_predict_real.csv"
    in_predict_res_file = "../../../../data/xdeepfm/predict/criteo_sampled_data_no_header_pred_res.txt"
