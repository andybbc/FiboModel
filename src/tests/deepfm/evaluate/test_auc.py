...
def process_demo():
    in_predict_real_file = "../../../../data/deepfm/etl/criteo_sampled_data_no_header_need_predict_real.csv"  # 真实情况
    in_predict_res_file = "../../../../data/deepfm/predict/criteo_sampled_data_no_header_pred_res.txt"  # 预估情况
...
def process_product():
    in_predict_real_file = "../../../../data/deepfm_product/etl/test.label"  # 真实情况
    in_predict_res_file = "../../../../data/deepfm_product/predict/test_res.txt"  # 预估情况
    y_test = np.loadtxt(in_predict_real_file)
    y_pred_test = np.loadtxt(in_predict_res_file)
    auc_entity = AUC(y_test, y_pred_test)
    res = auc_entity.auc_sklearn()
