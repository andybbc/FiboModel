...
def process_demo():
    dic_config = {
        "logger": 1,
        "origin_path": "../../../../data/deepfm/etl/criteo_sampled_data_no_header_need_predict.csv",
        "split_cols_file_path": "../../../../data/deepfm/preprocess/criteo_sampled_data_no_header_need_predict_select_col.csv",
        "encode_file_path": "../../../../data/deepfm/feature/criteo_sampled_data_no_header_need_predict_encode.csv",
...
def process_product():
    dic_config = {
        "logger": 1,
        "origin_path": "../../../../data/deepfm_product/etl/test.txt",
        "split_cols_file_path": "../../../../data/deepfm_product/preprocess/test.txt",
        "encode_file_path": "../../../../data/deepfm_product/feature/test_encode.txt",
