...
gflags.DEFINE_string('out_feature_importance_file', "../../../../data/deepfm/feature_importance.jpg", 'feature_importance_path')
...
def init():
    ...
    dic_config['feature_importance_path'] = Flags.out_feature_importance_file  # 特征重要性分析图
