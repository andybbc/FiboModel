...
from train import deepfm, xdeepfm
...
def init():
    ...
    dic_config["xdeepfm_model_path"] = Flags.out_model_path  # deepfm模型文件
...
def train():
    ...
    logger.info("""
        ...
        ##################################
    """)
    xdeepfm_train = xdeepfm.XDeepFMTrain(dic_config)
    xdeepfm_train.load_data_and_get_feature_names()
    xdeepfm_train.train()
