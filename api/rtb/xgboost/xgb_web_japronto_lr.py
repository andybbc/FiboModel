...
def query_predict(request):
    ...
    try:
        ...
        line_df = pd.DataFrame([input_list], columns=[i for i in range(1, len(input_list) + 1)])
        # print(line_df)
